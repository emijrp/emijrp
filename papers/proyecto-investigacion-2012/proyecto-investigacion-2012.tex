...
Wikipedia se ha constituido como una fuente de consulta... cuando sucede algún suceso de gran envergadura (desastres, eventos deportivos, fallecimientos de famosos), se ve reflejado en el número de visitas y ediciones a los artículos relacionados.
%http://wikipapers.referata.com/wiki/Seeking_health_information_online:_does_Wikipedia_matter%3F
%http://wikipapers.referata.com/wiki/Bieber_no_more:_First_Story_Detection_using_Twitter_and_Wikipedia
%http://wikipapers.referata.com/wiki/WikiPop_-_Personalized_Event_Detection_System_Based_on_Wikipedia_Page_View_Statistics


%http://rb.imm.dtu.dk/base/c/Lundbeck http://rb.imm.dtu.dk/base/c/

\subsection{Preservación}

%importancia

%quienes lo hacen? WP y pocos mas...
