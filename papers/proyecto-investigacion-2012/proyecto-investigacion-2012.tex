...
El resto del trabajo se divide de la siguiente manera. En la sección~2 hacemos un repaso a los distintos enfoques utilizados hasta ahora para recopilar toda la literatura sobre wikis, incidiendo en sus ventajas e inconvenientes. En la sección~3 ... En la sección~4 ... En la sección~5 presentamos WikiPapers, cómo funciona y qué pasos se están dando. En la sección~6 hacemos un estado del arte empleando WikiPapers. Finalmente, en la sección~7, terminamos con unas conclusiones y trabajo futuro.
...
Entre los objetivos de este proyecto de investigación se encuentran:
...
\item Deberá permitir añadir, eliminar y modificar metadatos bibliográficos fácilmente
\item Usará características de la web semántica para poder sacar el máximo provecho posible a los metadatos
\item Que tenga licencia libre (por tanto los contenidos serán reutilizables por terceros) y facilitar la adquisición y exportado de los metadatos
\item Realizar un estado del arte haciendo uso de este sistema
\end{enumerate}
