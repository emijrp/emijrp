...
A continuación se realiza un \textbf{estado del arte} dividiendo el estudio de los wikis en una serie de parcelas bien definidas.

\subsection{Autoría y calidad}

La naturaleza abierta de los wikis permite colaborar a todo aquel que lo desee. Se pueden modificar sus contenidos simplemente registrándose en el sitio y muchas veces hasta de forma anónima, como en el caso de Wikipedia. Esto ha llevado a debates, a veces calientes, sobre la calidad de los contenidos de los wikis y se han realizado comparaciones con formas más tradicionales de creación de obras.

%explicar un poco los historiales, que permiten saber quien mete qué

%comparación de Nature entre Wikipedia y la Britannica
