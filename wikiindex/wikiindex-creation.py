...
langs = {'ace': 'Acehnese', 'af': 'Afrikaans', 'aln': 'Gheg Albanian', 'am': 'Amharic', 'an': 'Aragonese', 'ang': 'Old English', 'ar': 'Arabic', 'arz': 'Egyptian Arabic', 'da': 'Danish', 'de': 'German', 'el': 'Greek', 'en': 'English', 'en-gb': 'English', 'es': 'Spanish', 'fi': 'Finnish', 'fr': 'French', 'hu': 'Hungarian', 'id': 'Indonesian', 'it': 'Italian', 'ka': 'Georgian', 'nl': 'Dutch', 'pl': 'Polish', 'pt': 'Portuguese', 'pt-br': 'Brazilian Portuguese', 'ru': 'Russian', 'sk': 'Slovak', 'sq': 'Albanian', 'sv': 'Swedish', 'tr': 'Turkish', 'ty': 'Tahitian', 'zh': 'Chinese', 'zh-cn': 'Chinese', 'zh-tw': 'Taiwanese Mandarin', }
start = ''
if len(sys.argv) == 2:
    start = sys.argv[1]
